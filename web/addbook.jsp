            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd class="layui-this"><a href="addbook.jsp">新建图书信息</a></dd>
                        <%}%>
                    </dl>
                </li>
                <li class="layui-nav-item">
    ...
    <div class="layui-body" style="bottom: 0;border-left: solid 2px #1AA094;" id="admin-body">
        ...
        <div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab">
            ...
            <div class="layui-container" align="center">
                <form class="layui-form" action="proc/dobookadd.jsp" method="post" >
                    <table class="layui-table" lay-skin="line">
                        <tbody>
                        <tr>
                            <td>书名：</td>
                            <td><input type="text" name="bookname" class="layui-input"></td>
                        </tr>
                        <tr>
                            <td>出版社：</td>
                            <td class="layui-input-block">
                                <select name="publisherSelect">
                                    <%
                                        while (rs.next()) {
                                    %>
                                    <option value="<%=rs.getString("publisherid")%>"><%=rs.getString("publishername")%>
                        ...
                        <tr>
                            <td>详情：</td>
                            <td><input type="text" name="details" class="layui-input"></td>
                        </tr>
                        </tbody>
                    </table>
                    <br>
