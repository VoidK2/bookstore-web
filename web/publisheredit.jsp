        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item  layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd  class="layui-this"><a href="publisherinfo.jsp">出版社信息</a></dd>
                        <%if(userP.equals("2")||userP.equals("3")){%>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="addaccount.jsp">新建账号</a></dd>
                    </dl>
                </li>
                <%}%>
            </ul>
    ...
    <div class="layui-body" style="bottom: 0;border-left: solid 2px #1AA094;" id="admin-body">
        ...
        <div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab">
            ...
            <div class="layui-container" align="center">
                <form class="layui-form" action="proc/dopublisheredit.jsp?pid=<%=pid%>" method="post" >
                    <table class="layui-table" lay-skin="line">
                        <tbody>
                        <tr>
                            <td>出版社名：</td>
                            <td><input type="text" name="publishername" class="layui-input" value="<%=rs.getString("publishername")%>"></td>
                        </tr>
                        <tr>
                            <td>地址：</td>
                            <td><input type="text" name="location" class="layui-input" value="<%=rs.getString("location")%>"></td>
                        </tr>
                        <tr>
                            <td>联系方式：</td>
                            <td><input type="text" name="contact" class="layui-input" value="<%=rs.getString("contact")%>"></td>
                        </tr>
                        </tbody>
                    </table>
                    <br>
