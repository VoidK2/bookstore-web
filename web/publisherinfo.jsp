...
//                当sission中有属性时
    ...
    <div class="layui-body" style="bottom: 0;border-left: solid 2px #1AA094;" id="admin-body">
        ...
        <%
            ...
            String sql = "select * from PublisherInfo" ;
        ...
        <div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab">
            ...
            <table class="layui-table" lay-skin="line">
                ...
                <tr>
                    ...
                    <%if(userP.equals("3")||userP.equals("2")){%>
                    <td>
                        <a href="publisheredit.jsp?pid=<%=rs.getString("publisherid")%>" class="layui-btn layui-btn-mini">编辑</a>
                        <a href="proc/dopublisherdelete.jsp?pid=<%=rs.getString("publisherid")%>" class="layui-btn layui-btn-danger layui-btn-mini">删除</a>
                    </td>
                    <%}%>
                </tr>
                <%}%>
