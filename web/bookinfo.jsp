...
//                当sission中有属性时
    ...
    <div class="layui-body" style="bottom: 0;border-left: solid 2px #1AA094;" id="admin-body">
        ...
        <%
            ...
            String sql = "select BookInfo.bookid,BookInfo.bookname,BookInfo.author,BookInfo.details,PublisherInfo.publishername" +
                    " from PublisherInfo,BookInfo" +
                    " where BookInfo.publisher=PublisherInfo.publisherid";
        ...
        <div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab">
            ...
            <table class="layui-table" lay-skin="line">
                ...
                <tr>
                    ...
                    <th>作者</th>
                    <th>详情</th>
                    <%if(userP.equals("3")||userP.equals("2")){%>
                    <th>操作</th>
                    <%}%>
                </tr>
                </thead>
                ...
                <tr>
                    ...
                    <%if(userP.equals("3")||userP.equals("2")){%>
                    <td>
                        <a href="bookedit.jsp?bid=<%=rs.getString("bookid")%>" class="layui-btn layui-btn-mini">编辑</a>
                        <a href="proc/dobookdelete.jsp?bid=<%=rs.getString("bookid")%>" class="layui-btn layui-btn-danger layui-btn-mini">删除</a>
                    </td>
                    <%}%>
                </tr>
                <%}%>
